...
import { ArrowLeft, ArrowRight, Gauge, ShieldCheck, Wine } from "lucide-react";
import { SectionLabel } from "@/components/page-primitives";
import { SiteFooter, SiteHeader } from "@/components/site-shell";
import { categoryDescription, glassBottleBeerProducts, sharedParameterRows } from "./data";

const productImage = "/images/products/beer-line-filling-machine.jpg";

export default function GlassBottleBeerFillingMachineCategoryPage() {
  return (
        ...
        <section className="industrial-grid border-b border-[#e2e8f0] bg-[#f9f9f9] pt-24">
          <div className="mx-auto grid min-h-[720px] max-w-[1200px] grid-cols-1 items-center gap-14 px-5 py-24 md:px-16 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <SectionLabel>Glass Bottle Beer Filling Machine</SectionLabel>
              <h1 className="mb-8 text-5xl font-bold uppercase leading-tight md:text-7xl">
                BDCGF Series Glass Beer Bottling Machine
              </h1>
            ...
            <div className="border border-[#e2e8f0] bg-white p-5 shadow-sm">
              <div className="relative aspect-square overflow-hidden bg-[#f5f7fa]">
                <img
                  alt="BDCGF series glass beer filling machine"
          ...
          <div className="mx-auto max-w-[1200px] px-5 md:px-16">
            <div className="mb-14 flex flex-col justify-between gap-6 border-b border-[#e2e8f0] pb-8 md:flex-row md:items-end">
              <div>
                ...
                <h2 className="text-4xl font-semibold uppercase">4 Glass Beer Filling Machines</h2>
              </div>
              <p className="max-w-md text-sm leading-6 text-slate-500">
                Titles follow the supplied glass beer document; parameters follow each BDCGF model
                column from the Excel table.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {glassBottleBeerProducts.map((product) => (
                <article
                ...
                >
                  ...
                  <div className="flex flex-col p-7">
                    ...
                    <Link
                      ...
                      href={`/products/glass-bottle-beer-filling-machine/${product.slug}`}
                    >
                      View Details
                      <ArrowRight size={14} />
                    </Link>
          ...
          <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 px-5 md:grid-cols-3 md:px-16">
            {[
              [
                Wine,
                "Glass Bottle Beer",
                "Designed for beer and purified beer filling in glass bottles.",
              ],
              [
                Gauge,
                "Automatic Line",
                "Different BDCGF models satisfy output needs from compact breweries to larger plants.",
              ],
              [
                ShieldCheck,
                "Integrated Control",
                "Rinsing, filling, and capping are combined into one automatic beer bottling unit.",
              ],
            ].map(([Icon, title, text]) => (
        ...
        <section className="bg-primary px-5 py-20 text-white md:px-16">
          <div className="mx-auto flex max-w-[1200px] flex-col justify-between gap-8 md:flex-row md:items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold">Need help choosing the right BDCGF model?</h2>
            </div>
            <Link
