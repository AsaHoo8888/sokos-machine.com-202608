...
import { ArrowLeft, Send, ShieldCheck, SlidersHorizontal, Wine } from "lucide-react";
import { SectionLabel } from "@/components/page-primitives";
import { SiteFooter, SiteHeader } from "@/components/site-shell";
import { getGlassBottleBeerProduct, glassBottleBeerProducts } from "../data";
...
export function generateStaticParams() {
  return glassBottleBeerProducts.map((product) => ({
    slug: product.slug,
  }));
}
...
export async function generateMetadata({ params }: ProductPageProps) {
  ...
  const product = getGlassBottleBeerProduct(slug);
...
export default async function GlassBottleBeerProductPage({ params }: ProductPageProps) {
  const { slug } = await params;
  const product = getGlassBottleBeerProduct(slug);
      ...
      <div className="mx-auto min-h-screen max-w-[2000px] bg-white shadow-sm">
        ...
        <section className="industrial-grid border-b border-[#e2e8f0] bg-[#f9f9f9] pt-24">
          <div className="mx-auto flex min-h-[760px] max-w-[1200px] flex-col gap-14 px-5 py-24 md:px-16">
            ...
            >
              <ArrowLeft size={16} />
              Back to glass beer filling machines
            </Link>
            ...
            <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
              <div>
                ...
                <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <div className="border-l-2 border-primary pl-4">
                    <div className="font-mono text-2xl">BDCGF 3-in-1</div>
                    <div className="font-mono text-[10px] uppercase tracking-[0.16em] text-slate-500">
          ...
          <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 px-5 md:grid-cols-3 md:px-16">
            {[
              ...
              [
                SlidersHorizontal,
                "Automatic Operation",
                "Integrated monoblock workflow supports daily brewery production.",
              ],
              [
                ShieldCheck,
                "Stable Parameters",
              ...
              <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_420px]">
                <div>
                  ...
                  <p className="mb-10 max-w-md leading-7 text-slate-600">
                    Send your bottle size, beer type, and target capacity. Sokos engineers will
                    match the machine layout and quotation for your glass beer bottling plant.
                  </p>
                ...
                <form className="flex flex-col gap-5">
                  ...
                  <textarea
                    ...
                    placeholder="Bottle size, beer type, cap type, and target output"
                  />
