...
import { ArrowLeft, ArrowRight, Gauge, ShieldCheck, Thermometer } from "lucide-react";
import { SectionLabel } from "@/components/page-primitives";
import { SiteFooter, SiteHeader } from "@/components/site-shell";
import { categoryDescription, juiceFillingProducts, sharedParameterRows } from "./data";

const productImage = "/images/products/juice-line-filling-machine.jpg";

export default function JuiceFillingMachineCategoryPage() {
  return (
        ...
        <section className="industrial-grid border-b border-[#e2e8f0] bg-[#f9f9f9] pt-24">
          <div className="mx-auto grid min-h-[720px] max-w-[1200px] grid-cols-1 items-center gap-14 px-5 py-24 md:px-16 lg:grid-cols-[1.05fr_0.95fr]">
            <div>
              ...
              <SectionLabel>Juice Filling Machine</SectionLabel>
              <h1 className="mb-8 text-5xl font-bold uppercase leading-tight md:text-7xl">
                RCGF Series Juice Hot Filling Machine
              </h1>
              ...
              <div className="mt-10 grid grid-cols-2 gap-6 md:grid-cols-3">
                {[
                  ["5 Models", "RCGF Series"],
                  ["6,000-18,000", "BPH Range"],
                  ["85-88°C", "Hot Fill"],
                ].map(([value, label]) => (
            ...
            <div className="border border-[#e2e8f0] bg-white p-5 shadow-sm">
              <div className="relative aspect-square overflow-hidden bg-[#f5f7fa]">
                <img
                  alt="RCGF series juice filling machine"
          ...
          <div className="mx-auto max-w-[1200px] px-5 md:px-16">
            <div className="mb-14 flex flex-col justify-between gap-6 border-b border-[#e2e8f0] pb-8 md:flex-row md:items-end">
              <div>
                ...
                <h2 className="text-4xl font-semibold uppercase">5 Juice Filling Machines</h2>
              </div>
              <p className="max-w-md text-sm leading-6 text-slate-500">
                Titles follow the supplied juice document; parameters follow each RCGF model column
                from the Excel table.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {juiceFillingProducts.map((product) => (
                <article
                ...
                >
                  ...
                  <div className="flex flex-col p-7">
                    ...
                    <div className="mt-auto grid grid-cols-1 gap-3 border-t border-[#e2e8f0] pt-5 font-mono text-xs md:grid-cols-2">
                      <span className="text-primary">Capacity: {product.parameters[0][1]}</span>
                    ...
                    <Link
                      ...
                      href={`/products/juice-filling-machine/${product.slug}`}
                    >
                      View Details
                      <ArrowRight size={14} />
                    </Link>
          ...
          <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 px-5 md:grid-cols-3 md:px-16">
            {[
              [
                Thermometer,
                "Hot Filling",
                "Suitable for juice, nectar, tea drinks, and milk beverages filled at 85-88°C.",
              ],
              [
                Gauge,
                "Stable Output",
                "Model options cover compact production through high-output juice bottling lines.",
              ],
              [
                ShieldCheck,
                "Integrated Control",
                "Rinsing, filling, and capping work together in one automatic hot-fill monoblock.",
              ],
            ].map(([Icon, title, text]) => (
        ...
        <section className="bg-primary px-5 py-20 text-white md:px-16">
          <div className="mx-auto flex max-w-[1200px] flex-col justify-between gap-8 md:flex-row md:items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold">Need help choosing the right RCGF model?</h2>
            </div>
            <Link
