    ...
    <main className="bg-[#07111f] text-white">
      ...
      <section className="relative min-h-[780px] overflow-hidden">
        <img
          ...
          src="/images/home-v2/turnkey-line-layout.png"
        />
      ...
      <section className="bg-white px-5 py-24 text-[#07111f] md:px-8 lg:py-32">
        <div className="mx-auto max-w-[1320px]">
          <div className="mb-14 flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            ...
            <ArrowButton href="/contact-v2" label="Start Project" />
          </div>

          <div className="grid gap-8">
            {solutionsV2.map((solution, index) => (
              <Link
                ...
                href={`/solutions-v2/${solution.slug}`}
                key={solution.slug}
              >
